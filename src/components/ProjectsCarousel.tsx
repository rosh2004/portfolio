            ...
            <CardContent className="flex items-center justify-center m-6 p-0 relative">
              ...
              <div className="absolute bottom-0 inset-x-0 flex justify-center">
                <div className="w-[300px] flex justify-center items-end">
                  {project.sourceCodeLink && <Link href={project.sourceCodeLink} className={`flex justify-center items-center flex-1 h-12 text-foreground-light bg-black/80 dark:bg-black/80 hover:bg-black dark:hover:bg-black rounded-none border-foreground-light ${project.projectLink && 'border-r'}`} >
                    <FaCode />
                  </Link>}
