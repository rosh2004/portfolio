  ...
  return (
    <div>
      <div className='flex flex-col-reverse lg:flex-row lg:justify-between items-center'>
        <div className='px-8 lg:pr-14 '>
          <h1 className='lg:text-7xl md:text-5xl text-4xl font-roboto font-medium mb-1'>Hi, I&apos;m <span className='text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary'>Roshaan Siddiqui!</span></h1>
          <h2 className='lg:text-4xl md:text-3xl text-2xl font-roboto font-medium opacity-60 '>Full Stack Web Developer</h2>
